            ...
            <div class="card-body">
               <div class="row mb-3">
                   ...
                   <div class="col-md-8">
                       ...
                       @if($folderParentId != 0)
                           <a href="{{ route('emp.file-manager.view', ['folders' => $parentFolderUrl, 'id' => $folderParentId]) }}" class="btn btn-outline-primary">
                               Back
                           </a>
                       @else
                           <a href="{{ route('emp.file-manager.index') }}" class="btn btn-outline-primary">
                               Back
                           </a>
                       @endif
                   </div>
                ...
                <nav aria-label="breadcrumb" class="custom-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('emp.file-manager.index') }}">
                        ...
                        @foreach($ancestors as $ancestor)
                            ...
                            @if($anchorFolderurl)
                                <li class="breadcrumb-item">
                                    <a href="{{ route('emp.file-manager.view', ['folders' => $anchorFolderurl, 'id' => $ancestor->id]) }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">           
            ...
            <div class="modal-body">
                <form id="createFolderForm" action="{{ route('emp.file.storeFolder') }}" method="POST">
                    @csrf
                    <div class="mb-3">
...
<div class="modal fade" id="uploadFileModal" tabindex="-1" aria-labelledby="uploadFileModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">           
            ...
            <div class="modal-body">
                <form id="createFolderForm1" action="{{ route('emp.file.upload') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
...
<div class="modal fade" id="copyFolderModal" tabindex="-1" aria-labelledby="copyFolderModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="copyFolderForm" action="{{ route('emp.file.copy') }}" method="POST">
                    @csrf
...
<div class="modal fade" id="moveFolderModal" tabindex="-1" aria-labelledby="moveFolderModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="moveFolderForm" action="{{ route('emp.file.move') }}" method="POST">
                    @csrf
                    <!-- Hidden fields to hold the source file/folder info -->
...
<div class="modal fade" id="renameFolderModal" tabindex="-1" aria-labelledby="renameFolderModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="renameFolderForm" action="{{ route('emp.file.rename') }}" method="POST">
                    @csrf
                    <!-- Hidden fields to hold the source file/folder info -->
...
<div class="modal fade" id="DeleteFolderModal" tabindex="-1" aria-labelledby="DeleteFolderModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="deleteFolderForm" action="{{ route('emp.file.delete') }}" method="POST">
                    @csrf
                    <!-- Hidden fields to hold the source file/folder info -->
...
<script>
    ...
    if (type === 2) {
        window.location.href = "{{ route('emp.file.download', ':filePath') }}".replace(':filePath', filePath);
    } else if (type === 1) {
        window.location.href = "{{ route('emp.folder.download', ':filePath') }}".replace(':filePath', filePath);
    }
}
...
function loadChildFolders(parentId, element) {
    ...
    const url = "{{ route('emp.file.childname', ['parentId' => '__parentId__']) }}".replace('__parentId__', parentId);
...
function updateBreadcrumb(parentId, folderUrl, childFolders) {
    ...
    const url = "{{ route('emp.file.breadcrumn', ['parentId' => '__parentId__']) }}".replace('__parentId__', parentId);
