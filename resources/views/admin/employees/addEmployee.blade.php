      ...
      <div class="col-12 grid-margin stretch-card">
         <div class="card">
            <div class="card-body">
               ...
               <form class="forms-sample" action="{{route('employees.store')}}" name="employeeForm" id="employeeForm" method="post" onsubmit="return addEmployee()" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                           <label for="exampleInputName1">Name of the Employee<span class="required" style="color:red;">*</span></label>
                           <input type="text" class="form-control" name="employee_name" id="employee_name" placeholder="Name of the employee">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="email" class="form-control" name="official_emailid" id="official_emailid" placeholder="Email id official">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="tel" class="form-control" name="mobile_number" id="mobile_number" placeholder="Mobile number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="10">
                  ...
                  <div class="row" id="archive_div" style="display:none;">
                     <div class="col-md-6">
                        <div class="form-group">
                           <label for="exampleInputName1">Archive Permission</label>    
                           <select class="form-control" name="archive_permission" id="archive_permission">
                  ...
                  <input type="hidden" name="nameofthebu_ids" id="nameofthebu_ids" value="0">
                  <input type="hidden" name="countrycode" class="cc" value="India (भारत)+91">
                  <input type="hidden" name="countrycode1" class="cc1" value="India (भारत)+91">
                  <input type="hidden" name="countrycode2" class="cc2" value="India (भारत)+91">
                  <input type="hidden" name="emgcountrycode" class="emgcc" value="India (भारत)+91">
                  <input type="hidden" name="emgcountrycode1" class="emgcc1" value="India (भारत)+91">
